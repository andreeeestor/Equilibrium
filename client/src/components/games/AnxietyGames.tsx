...
const games = [
  {
    ...
    description:
      "Siga exercícios de respiração relaxantes com orientação visual",
    icon: Wind,
    color: "text-blue-500",
  ...
  },
  {
    id: "garden",
    title: "Jardim Zen",
    description: "Crie e mantenha seu espaço digital de paz",
    icon: Flower2,
    color: "text-rose-500",
  ...
  {
    id: "forest",
    title: "Floresta Consciente",
    description: "Faça uma caminhada tranquila por uma floresta virtual",
    icon: TreePine,
  ...
  },
  {
    ...
    description: "Sincronize sua respiração com ondas suaves do oceano",
    icon: Waves,
    color: "text-cyan-500",
  ...
  const handleGameStart = async (gameId: string) => {
    ...
    if (onGamePlayed) {
      try {
        ...
        console.error("Erro ao registrar atividade do jogo:", error);
      }
    }
  };
      ...
      <Card className="border-primary/10">
        <CardHeader>
          <CardTitle className="text-xl font-semibold flex items-center gap-2">
            ...
            Atividades para Alívio da Ansiedade
          </CardTitle>
          <CardDescription>
            Exercícios interativos para ajudar a reduzir o estresse e a
            ansiedade
          </CardDescription>
        </CardHeader>
        <CardContent>
