...
export default function Header() {
  ...
  return (
    <div className="w-full fixed top-0 z-50 bg-background/95 backdrop-blur">
      ...
      <header className="relative max-w-6xl mx-autp px-4">
        <div className="flex h-16 items-center justify-between">
          <Link
            className="flex items-center space-x-2 transition-opacity hover:opacity-80"
            href={"/"}
          >
            <AudioWaveform className="size-7 text-primary animate-pulse" />
            <div className="flex flex-col">
              <span className="text-lg font-semibold bg-linear-to-r from-primary to-primary/80 text-transparent bg-clip-text">
                Equilibrium
              </span>
            </div>
          </Link>
