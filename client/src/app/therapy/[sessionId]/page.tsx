      ...
      <div className="flex h-[calc(100vh-4rem)] mt-20 gap-6">
        <div className="flex-1 flex flex-col overflow-hidden bg-white dark:bg-background rounded-lg border">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h2 className="font-semibold">Serena</h2>
                ...
                <div className="text-center space-y-4">
                  <div className="relative inline-flex flex-col items-center">
                    ...
                    <div className="relative flex items-center gap-2 text-2xl font-semibold">
                      ...
                      <h2 className="bg-linear-to-r from-primary/90 to-primary bg-clip-text text-transparent text-3xl">
                        Serena
                      </h2>
                    </div>
                        ...
                        <div className="flex-1 space-y-2 overflow-hidden min-h-8">
                          <div className="flex items-center justify-between">
                            <p className="font-medium text-sm">
                              {msg.role === "assistant" ? "Serena" : "Você"}
                            </p>
                ...
                {isTyping && (
                  ...
                  >
                    ...
                    <div className="flex-1 space-y-2">
                      <p className="font-medium text-sm">Serena</p>
                      <p className="text-sm text-muted-foreground">
                        Digitando...
                      </p>
                    </div>
          ...
          <div className="border-t bg-background/50 backdrop-blur supports-backdrop-filter:bg-background/50 p-4">
            ...
            <div className="mt-2 text-xs text-center text-muted-foreground">
              Pressione{" "}
              <kbd className="px-2 py-0.5 rounded bg-muted">Enter ↵</kbd> para
              enviar,
